...
@Component({
  selector: 'app-architdpp',
  templateUrl: './architdpp.component.html',
  styleUrls: ['./architdpp.component.css']
})
export class ArchitdppComponent {
  ...
  constructor(private fileUploadService: ArchitdpService, private toastr:ToastrService ,private fileService:ArchitdpService) { }
