...
@Component({
  selector: 'app-archicourp',
  templateUrl: './archicourp.component.html',
  styleUrls: ['./archicourp.component.css']
})
export class ArchicourpComponent {
  searchText:any;
  selectedFile: File | null = null;
  uploadProgress!: number;
  fileDetails = null as any;

  constructor(private fileUploadService: ArchicourService, private toastr:ToastrService ,private fileService: ArchicourService) { }
